...
public class NavigationPage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownTimer = (TextView)findViewById(R.id.textView4);
...
//        countDownTimer.setText(quotesProvider.timer());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.to_do) {
            Intent A = new Intent (NavigationPage.this, TodoActivity.class);
            startActivity(A);
